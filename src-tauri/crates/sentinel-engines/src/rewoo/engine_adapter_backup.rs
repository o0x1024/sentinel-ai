...
// DISABLED: use crate::ai_adapter::AiProvider;
...
impl ReWooEngine {
    ...
    // DISABLED: All ReWOO functionality removed
    ...
    async fn get_ai_provider_from_service_manager(
        ...
        // DISABLED: use crate::ai_adapter::providers::ProviderFactory;
        // DISABLED: use crate::ai_adapter::types::ProviderConfig;
