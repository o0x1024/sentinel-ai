...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(generate_handler![
            ...
            commands::agent_task_commands::get_agent_tasks_for_conversation,
            commands::agent_task_commands::prune_agent_tasks_after,
            commands::ai_runtime_harness::get_agent_harness_runs,
            commands::ai_runtime_harness::get_agent_harness_events,
            commands::ai_runtime_harness::get_agent_harness_checkpoints,
            commands::ai_runtime_harness::prune_agent_harness_after,
            commands::list_bot_accounts,
            commands::list_bot_peers,
            commands::list_bot_messages_for_peer,
            ...
            db_commands::cleanup_legacy_team_v3_data,
            ...
            commands::bounty_batch_update_change_event_status,
            commands::bounty_batch_delete_change_events,
            ...
            commands::monitor_create_tasks_for_programs,
            ...
            commands::surface_list_seeds,
            commands::surface_list_seed_candidates,
            commands::surface_query_seeds,
            commands::surface_get_seed_distribution,
            commands::surface_upsert_seed,
            commands::surface_delete_seed,
            commands::surface_batch_delete_seeds,
            commands::surface_delete_filtered_seeds,
            commands::surface_review_seed_candidates,
            commands::surface_count_legacy_synced_seeds,
            commands::surface_retire_legacy_synced_seeds,
            commands::surface_sync_program_seeds,
            ...
            commands::plugin_review_commands::get_plugin_input_schema_from_code,
            ...
            commands::list_working_directory_entries,
            commands::search_working_directory_files,
            commands::read_working_directory_file_preview,
            commands::write_working_directory_file,
            commands::resolve_working_directory_file_open_target,
            commands::create_working_directory_entry,
            commands::rename_working_directory_entry,
            commands::delete_working_directory_entry,
            commands::watch_working_directory_path,
            commands::stop_working_directory_watch,
            ...
            commands::team_v4_harness::team_v4_finish_harness_run,
            commands::team_v4_harness::team_v4_mark_expired_harness_runs,
            commands::team_v4_harness::team_v4_conversation_harness_snapshot,
            commands::team_v4_harness::prune_team_v4_runs_after,
