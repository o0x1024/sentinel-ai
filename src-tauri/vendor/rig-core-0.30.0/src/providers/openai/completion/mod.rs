            ...
            |(mut texts, mut tools), content| {
                match content {
                    ...
                    message::AssistantContent::Reasoning(_) => {
                        tracing::warn!(
                            "Dropping assistant reasoning content because OpenAI Completions API doesn't support reasoning"
                        );
                    }
                    message::AssistantContent::Image(_) => {
                        tracing::warn!(
                            "Dropping assistant image content because OpenAI Completions API doesn't support assistant images"
                        );
                    }
                }
                (texts, tools)
