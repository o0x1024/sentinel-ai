...
import bugBountyPro from './bugBountyPro/zh'
...
export default {
  ...
  plugins: {
    ...
    pluginReview: '插件审核',
    selectionSummary: '已选 {selected} 个，当前页 {page} 个，筛选结果共 {total} 个',
    batchEnableSelected: '启用选中',
    batchDisableSelected: '停用选中',
    batchDeleteSelected: '删除选中',
    batchDeleteConfirmTitle: '确认批量删除',
    batchDeleteConfirm: '确定删除选中的 {count} 个插件吗？此操作不可撤销。',
    batchDeleteSelectedSuccess: '已删除 {count} 个选中插件',
    batchDeleteSelectedFailed: '批量删除插件失败',
    batchEnableSelectedSuccess: '已启用 {count} 个选中插件',
    batchDisableSelectedSuccess: '已停用 {count} 个选中插件',
