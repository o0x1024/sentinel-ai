...
export default {
  ...
  textCodec: {
    noSelection: '请先选中要编解码的文本',
    applied: '已执行{action}',
    failed: '编解码失败：{error}',
  },
  codec: {
    transparentCodec: '透明加解密',
    codecViewOn: '解密视图 (已启用)',
    codecViewOff: '解密视图 (已关闭)',
    createCodecRule: '创建解密规则...',
    manageCodecRules: '管理规则...',
    importCodecRules: '导入规则...',
    badge: {
      decoding: '已解密',
      raw: '原始数据',
      toggleDecode: '点击切换为解密视图',
      toggleDecodeWithRules: '已解密显示 ({names})',
    },
    ruleDialog: {
      createTitle: '新建 Codec 规则',
      editTitle: '编辑 Codec 规则',
      name: '规则名称',
      namePlaceholder: '输入规则名称',
      matchConditions: '匹配条件',
      host: 'Host',
      hostPlaceholder: '例如 api.example.com 或 *.example.com',
      path: 'Path',
      ...
      scopeTarget: '类型',
      scopeFields: '字段',
      scopeFieldsPlaceholder: '逗号分隔，例如 data, payload.token',
      scopeHeader: 'Header',
      scopeHeaderPlaceholder: '例如 Authorization',
      scopePattern: 'Pattern',
      scopePatternPlaceholder: '正则表达式',
      pipeline: '解密管道',
      addStep: '添加步骤',
      preview: '预览',
      previewInput: '输入',
      previewInputPlaceholder: '输入测试内容',
      previewOutput: '输出',
      previewOutputPlaceholder: '测试结果将显示在这里',
      testDecode: '测试解密',
      testEncode: '测试加密',
      save: '保存',
      saving: '保存中...',
    ...
    rulesPanel: {
      ...
      emptyState: '暂无规则，点击"新建规则"创建第一条解密规则',
      codecSummary: '{count} 个步骤',
      noSteps: '无步骤',
      exportFailed: '导出失败',
    },
    importDialog: {
      ...
      detectedRules: '检测到 {count} 条规则',
      detectedRulesWithKeys: '检测到 {count} 条规则, 需要填写以下密钥:',
      fillKeys: '需要填写以下密钥:',
      import: '导入',
      importing: '导入中...',
      cancel: '取消',
      close: '关闭',
      invalidFormat: '无效的规则文件格式',
    ...
    pipelineEditor: {
      codecType: 'Codec 类型',
      selectCodec: '选择 Codec',
      key: '密钥 (key)',
      keyPlaceholder: '密钥',
      keyFormat: '密钥格式',
      iv: 'IV',
      ivPlaceholder: '初始化向量 (16 字节)',
      ivFormat: 'IV 格式',
      variant: '变体',
      standard: 'Standard',
      urlSafe: 'URL-Safe',
      noConfig: '此编解码器无需额外配置',
      enabled: '启用',
      remove: '移除',
      dragSort: '拖拽排序',
      deleteStep: '删除步骤',
      deleteConfigKey: '删除配置项',
      addConfigEntry: '添加配置项',
      configKey: '键',
      configValue: '值',
      pkcs7Padding: '填充方式：PKCS#7',
      xorKeyPlaceholder: 'XOR 密钥',
      formatHex: 'Hex',
      formatBase64: 'Base64',
      formatUtf8: 'UTF-8',
      addStep: '添加步骤',
    ...
    errors: {
      decodeFailed: '解密失败: {error}',
      encodeFailed: '编码失败: {error}',
    },
  },
  httpEditor: {
  ...
  workbench: {
    ...
    toolDescriptions: {
      capture: '同页查看网络抓包结果，不再单独切出流量分析工作台。',
      repeater: '单条请求精修和重放只在需要时展开，不常驻占用主视图。',
      intruder: '批量化尝试收进底部工作台，避免把同屏密度拉高。',
      comparer: '只在确认差异时临时展开，看完后立即回到主工作流。',
      oast: '集中生成和跟踪 OAST token，不再分散在各个测试工具里。',
    },
    findingToast: '[{severity}] 发现漏洞: {summary} @ {host}',
    basket: {
      kicker: 'Request Basket',
      title: '请求篮子',
      description: '先收集高价值请求，再批量发送到重放器或爆破器。',
      sendAllToRepeater: '全部发送到重放器',
      sendAllToIntruder: '全部发送到爆破器',
      clear: '清空篮子',
      empty: '历史记录和拦截队列里的高价值请求，可以先放到这里再统一处理。',
      openSourceRequest: '查看源请求',
    },
    sidebar: {
      title: '工作台',
      draftStack: '重放器历史',
    ...
    stats: {
      snapshots: '快照',
      snapshotsMeta: '历史快照',
      repeaterHistory: '重放器历史',
      repeaterHistoryMeta: '重放记录',
      replay: '重放',
      intruderHistory: '爆破器历史',
  ...
  history: {
    ...
    errors: {
      ...
      exportFailed: '导出失败',
      invalidScopeRuleUrl: '无法从该历史记录生成范围规则',
      scopeRuleSaveFailed: '保存范围规则失败: {error}',
      networkError: '网络错误',
      timeout: '请求超时',
      unknown: '未知错误',
    },
    messages: {
      ...
      draftCreated: '已发送到重放器',
      compareOpened: '已发送到对比器',
      noSelectionForSend: '请先选择要发送的请求',
      sentBatchToRepeater: '已发送 {count} 条请求到重放器',
      sentBatchRequestsToComparer: '已发送 {count} 条请求到对比器',
      sentBatchToIntruder: '已发送 {count} 条请求到爆破器',
  ...
  proxyConfiguration: {
    ...
    pluginRuntimeDesc:
      '配置统一请求队列的全局运行时默认值。这里的节流、并发、排队和超时会直接作用于各类插件发起的请求。',
    pluginRuntimeActiveProbeOnlyDesc:
      '这里只配置流量分析使用的主动探测策略。其它插件类型的统一请求调度已迁移到插件管理。',
    pluginRuntimeFetchHint:
      '保存后会立即更新统一请求调度器。主动探测、漏洞赏金、监控、Agent 工具和插件测试都会读取这里的对应策略。',
    pluginRuntimeActiveProbeOnlyHint:
      '保存后仅更新主动探测策略；漏洞赏金、监控、Agent 工具和插件测试请到插件管理中调整。',
    pluginRuntimePolicyActiveProbeTitle: '流量分析主动探测策略',
    pluginRuntimePolicyActiveProbeDesc:
      '流量分析插件的主动探测请求。适合控制扫描节奏和单目标打点强度。',
    pluginRuntimePolicyBountyTitle: '漏洞赏金自动化工作流队列',
    pluginRuntimePolicyBountyDesc: '漏洞赏金与资产探测类插件的主动请求队列。',
    pluginRuntimePolicyMonitorTitle: '漏洞赏金监控任务队列',
    pluginRuntimePolicyMonitorDesc:
      '漏洞赏金监控模块插件的主动请求队列。默认用于常规巡检；大资产巡检可切换本地验证预设提高吞吐。',
    pluginRuntimePolicyAgentTitle: 'Agent 工具队列',
    pluginRuntimePolicyAgentDesc: 'Agent/工具型插件的主动请求队列。',
    pluginRuntimePolicyPluginTestTitle: '插件测试队列',
    ...
    pluginRuntimeQueueQueuedScheduled: '排队 / 已调度',
    pluginRuntimeQueueActiveRunsPlugins: '活跃运行 / 插件',
    pluginRuntimeQueueHostPeak: '最热主机并发',
    pluginRuntimeQueueCancelledRuns: '已取消运行',
    pluginRuntimeQueueHottestHost: '最热主机',
    pluginRuntimeQueueRejectReasons: '拒绝原因分布',
    pluginRuntimeQueueRejectQueueLimit: '队列深度上限',
    pluginRuntimeQueueRejectRunPending: '单次运行待处理上限',
    pluginRuntimeQueueRejectPluginPending: '单插件待处理上限',
    pluginRuntimeQueueRejectCancelledRun: '运行已取消',
    pluginRuntimeQueueTrendTitle: '短时趋势',
    pluginRuntimeQueueTrendPending: '待处理',
    pluginRuntimeQueueTrendRunning: '运行中',
    pluginRuntimeQueueTrendRejected: '已拒绝',
    pluginRuntimeQueueTrendThroughput: '吞吐率',
    ...
    directFetchTitle: '插件直连请求',
    directFetchDesc: '限制 bounty / monitor / agent 等插件通过 fetch 直连发出的 HTTP 并发数，不影响 activeProbe 队列。',
    directFetchMaxConcurrent: '直连请求全局最大并发数',
