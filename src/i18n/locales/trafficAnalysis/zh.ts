...
export default {
  ...
  comparer: {
    ...
    messages: {
      ...
      sentToRepeater: '已将 {label} 发送到重放器',
    },
    draft: {
      title: '手动对比',
  ...
  proxyConfiguration: {
    ...
    pluginRuntimeDesc: '配置流量插件的全局运行时默认值。这些配置会影响主动探测的调度节流和超时行为。',
    ...
    pluginRuntimeActiveProbeHint: '这些值会作为流量插件主动探测的全局默认值。当前调度粒度按 host + pathname 进行限并发和节流；保存后会立即生效。',
  ...
  oast: {
    ...
    payloads: 'Payload',
    events: '命中事件',
    deleteActivityTitle: '最近删除操作',
    deleteActivityDesc: '显示当前会话最近几次远端删除与本地同步结果。',
    clearDeleteActivity: '清空日志',
    copyDeleteActivity: '复制摘要',
    copiedDeleteActivity: '已复制删除摘要',
    deleteActivityActionLabel: '操作',
    deleteActivityTimeLabel: '时间',
    deleteActivitySummaryLabel: '结果',
    selectAllFiltered: '全选当前过滤结果',
    clearSelection: '清空选择',
    deleteEvent: '删除事件',
    deleteSelectedEvents: '批量删除',
    deleteEventAction: '删除事件',
    deleteRecordAction: '删除记录',
    deleteSelectedEventsAction: '批量删除 {count} 条事件',
    noEvents: '暂时还没有回连事件。',
    createdAt: '创建时间',
    lastHitAt: '最近命中',
    hitCount: '命中 {count} 次',
    ...
    deletedEvents: '已删除 {count} 条事件',
    deletedEventsSummary: '远端已删除 {deleted} 条事件，本地已同步剩余 {remaining} 条。',
    ...
    confirmDeleteEvent: '确认删除这条命中事件吗？',
    confirmDeleteSelectedEvents: '确认批量删除已选中的 {count} 条命中事件吗？',
