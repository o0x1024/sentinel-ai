...
export default {
  ...
  comparer: {
    ...
    messages: {
      ...
      sentToRepeater: 'Sent {label} to Repeater',
    },
    draft: {
  ...
  proxyConfiguration: {
    ...
    pluginRuntimeDesc: 'Configure global runtime defaults for traffic plugins. These values apply to active probe scheduling and timeout behavior.',
    ...
    pluginRuntimeActiveProbeHint: 'These values act as global defaults for traffic plugin active probes. Scheduling now applies concurrency and cooldown at the host + pathname level and takes effect immediately after saving.',
  ...
  oast: {
    ...
    payloads: 'Payloads',
    events: 'Events',
    deleteActivityTitle: 'Recent delete activity',
    deleteActivityDesc: 'Shows the latest remote deletions and local sync results in this session.',
    clearDeleteActivity: 'Clear log',
    copyDeleteActivity: 'Copy summary',
    copiedDeleteActivity: 'Delete summary copied',
    deleteActivityActionLabel: 'Action',
    deleteActivityTimeLabel: 'Time',
    deleteActivitySummaryLabel: 'Result',
    ...
    deleteSelectedEventsAction: 'Delete {count} selected event(s)',
    ...
    deletedEvents: '{count} event(s) deleted',
    deletedEventsSummary: 'Remote deleted {deleted} event(s); local sync now shows {remaining} remaining.',
    ...
    confirmDeleteEvent: 'Delete this callback event?',
    confirmDeleteSelectedEvents: 'Delete the selected {count} callback event(s)?',
