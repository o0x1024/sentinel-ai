export default {
  ...
  auditModeHint: 'Enable audit-oriented orchestration and evidence-first outputs',
  auditScope: 'Audit Scope',
  auditScopeRepo: 'Repository',
  auditScopeGitDiff: 'Git Diff Only',
  auditScopePaths: 'Selected Paths',
  verificationLevel: 'Verification Level',
  verificationLow: 'Low',
  verificationMedium: 'Medium',
  verificationHigh: 'High',
  policyProfile: 'Policy Profile',
  policyBalanced: 'Balanced',
  policyStrict: 'Production Strict',
  auditMandatoryTools: 'Mandatory Audit Tools',
  auditMandatoryToolsHint: 'These tools are always injected in audit mode and cannot be removed.',
  auditAdditionalTools: 'Additional Exposed Tools',
  auditAdditionalToolsHint: 'Optional extra tools to expose in audit mode across any strategy, including Skills.',
  auditAdditionalToolsPlaceholder: 'Search tool name, id, or description',
  requiredAuditTools: 'Required Audit Tools',
  requiredAuditToolsPlaceholder: 'e.g. code_search, git_diff_scope',
  auditFindings: 'Audit Findings',
  viewAuditFindings: 'View Audit Findings',
  auditFindingsPanelOpen: 'Audit Findings Panel Open',
  noAuditFindings: 'No structured audit findings yet',
  affectedFiles: 'Affected Files',
  recommendedFix: 'Recommended Fix',
  hitDetails: 'Hit Details',
  sourceLabel: 'Source',
  sinkLabel: 'Sink',
  policyGatePassed: 'Policy Gate Passed',
  policyGateBlocked: 'Policy Gate Blocked',
  policyGateDefaultPass: 'No blocking condition matched for current policy',
  policyGateDefaultBlock: 'Blocking condition matched for current policy',
  auditSummaryTitle: 'Code Audit Summary',
  auditSummaryTotal: 'Total Findings',
  auditSummaryCritical: 'Critical',
  auditSummaryHigh: 'High',
  auditSummaryMedium: 'Medium',
  auditSummaryLow: 'Low',
  auditSummaryViewDetails: 'View full vulnerability details in Security Center > Code Audit.',

  // Security Rules Management
  securityRules: 'Security Rules',
  securityRulesManagement: 'Security Rules Management',
  securityRulesTab: 'Rule Management',
  findingsTab: 'Audit Findings',
  addRule: 'Add Rule',
  editRule: 'Edit Rule',
  deleteRule: 'Delete Rule',
  deleteRuleConfirm: 'Are you sure you want to delete this rule? This action cannot be undone.',
  ruleName: 'Rule Name',
  ruleNamePlaceholder: 'e.g. SQL Injection Detection',
  ruleCwe: 'CWE ID',
  ruleCwePlaceholder: 'e.g. CWE-89',
  ruleSeverity: 'Severity',
  ruleDescription: 'Description',
  ruleDescriptionPlaceholder: 'Describe the security issue this rule detects...',
  ruleSources: 'Sources',
  ruleSourcesHint: 'Define input source patterns',
  ruleSinks: 'Sinks',
  ruleSinksHint: 'Define sensitive operation target patterns',
  ruleSanitizers: 'Sanitizers',
  ruleSanitizersHint: 'Define sanitization/validation function patterns',
  patternName: 'Pattern',
  patternNamePlaceholder: 'e.g. req.body or *.query',
  patternLanguages: 'Languages',
  patternLanguagesPlaceholder: 'Leave empty for all languages',
  patternDescription: 'Description',
  addPattern: 'Add Pattern',
  removePattern: 'Remove',
  saveRule: 'Save Rule',
  cancelEdit: 'Cancel',
  ruleBuiltinBadge: 'Built-in',
  ruleCustomBadge: 'Custom',
  ruleEnabled: 'Enabled',
  ruleDisabled: 'Disabled',
  noSecurityRules: 'No security rules',
  seedBuiltinRules: 'Import Built-in Rules',
  seedBuiltinRulesConfirm: 'Import built-in security rules to database. Existing rules will be updated.',
  seedSuccess: 'Successfully imported {count} built-in rules',
  ruleSourceCount: '{count} sources',
  ruleSinkCount: '{count} sinks',
  ruleSanitizerCount: '{count} sanitizers',
