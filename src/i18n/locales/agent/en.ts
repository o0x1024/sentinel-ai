export default {
  ...
  preselectedTools: 'Preselected Tools',
  none: 'None',
  ...
  skillBatchDeleteConfirm: 'Delete the selected {count} skills?',
  skillDeleteAllConfirm: 'Delete all {count} skills?',
  skillDeleteNotFound: 'Skill no longer exists',
  skillDeleteFailed: 'Failed to delete skill',
  skillSearchPlaceholder: 'Search skill name, ID, description, path, or tools',
  skillSearchEmpty: 'No matching skills found',
  skillFilteredCount: 'Showing {count} / {total}',
  skillSelectedCount: '{count} selected',
  deleteSelectedSkills: 'Delete Selected',
  deleteAllSkills: 'Delete All',
  skillPageInfo: 'Page {page} / {total}',
  skillPaginationSummary: 'Showing {start}-{end} of {total}',
  skillPaginationEmpty: 'No items to show',
  ...
  skillInvokedTitle: 'Skill Invoked',
  skillForkedTitle: 'Skill Ran in Sub-Agent',
  skillInvokeFailedTitle: 'Skill Invocation Failed',
  skillModeInvoke: 'Inline',
  skillModeFork: 'Forked',
  skillReadFileTitle: 'Loading Helper File',
  skillHelperFilesLabel: 'Helper files loaded',
  skillHelperFileEmpty: 'No file content to display',
  skillHelperWarningsLabel: 'Helper file warnings',
  skillForkResultLabel: 'Result',
  skillInvokeSummaryLabel: 'Summary',
  skillInvokeRunningText: 'Loading skill {skill}…',
  skillForkRunningText: 'Running skill in sub-agent…',
  skillStatusRunning: 'Running',
  skillStatusCompleted: 'Completed',
...
`,
  ...
  sessionStatsFirstResponse: 'First response',
  ...
  thinkingStats: '{lines} lines / {chars} chars',
  expandThinkingFull: 'Expand all',
  limitThinkingHeight: 'Limit height',
  ...
  toolCardFileReadTitle: 'Read file',
  toolCardFileWriteTitle: 'Write file',
  toolCardFileEditTitle: 'Edit file',
  toolCardGlobTitle: 'Find files',
  toolCardGrepTitle: 'Search content',
  toolCardPath: 'Path',
  toolCardPattern: 'Pattern',
  toolCardBasePath: 'Base path',
  toolCardFiles: 'Files',
  toolCardMatches: 'Matches',
  toolCardMatchedFiles: 'Matched files',
  toolCardBytes: 'Bytes',
  toolCardReplacements: 'Replacements',
  toolCardLineRange: 'Lines',
  toolCardLineNumber: 'Line',
  toolCardTotalLines: 'total lines',
  toolCardChangedLines: 'changed lines',
  toolCardFirstChangedLine: 'first changed line',
  toolCardAddedLines: 'added lines',
  toolCardRemovedLines: 'removed lines',
  toolCardOperationCreate: 'Create',
  toolCardOperationOverwrite: 'Overwrite',
  toolCardBefore: 'Before',
  toolCardAfter: 'After',
  toolCardChanges: 'Changes',
  toolCardTruncated: 'Truncated',
  toolCardLimit: 'Limit',
  toolCardViewDetails: 'View structured payload',
  toolCardRawPayload: 'Raw payload',
  toolCardNoStructuredOutput: 'Structured preview unavailable',
  toolCardErrorOutput: 'Error output',
  toolCardReadbackVerified: 'Readback verified',
  toolCardReadbackPending: 'Readback pending',
  toolCardWriteFailed: 'Write failed',
  ...
  retrievedMemoryTitle: 'Injected Memory',
  retrievedMemorySummary: '{hits} memories · ~{tokens} tokens',
  retrievedMemoryLoading: 'Loading memory details…',
  retrievedMemoryEmpty: 'No memory content to display',
  retrievedMemoryAutoInjectDisabled: 'Auto-inject disabled',
  retrievedMemoryOpenInTools: 'Open in Tools',
  retrievedMemoryEnableAutoInject: 'Enable auto-inject',
  retrievedMemoryDisableAutoInject: 'Disable auto-inject',
  retrievedMemoryEditTitle: 'Edit Memory',
  retrievedMemoryEditKind: 'Kind',
  retrievedMemoryEditTitleField: 'Title',
  retrievedMemoryEditText: 'Content',
  retrievedMemoryDeleteConfirm: 'Delete this memory? It will no longer be auto-retrieved.',

  // Pre-run memory preview
  memoryPreviewTitle: 'Preview Memory Injection',
  memoryPreviewButton: 'Preview memory',
  memoryPreviewLoading: 'Retrieving related memories…',
  memoryPreviewEmpty: 'No memories matched for auto-injection',
  memoryPreviewQuery: 'Retrieval Query',
  memoryPreviewHits: 'Matches',
  memoryPreviewMode: 'Retrieval Mode',
  memoryPreviewClose: 'Close',
