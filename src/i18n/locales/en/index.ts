...
export default {
  ...
  plugins: {
    ...
    defaultConfigHint: 'Default configuration will be used if none is provided.',
    formMode: 'Form',
    formModeHint: 'Edit the configuration fields using the form view.',
    jsonMode: 'JSON',
    advancedJsonHint: 'Advanced mode: edit the plugin configuration JSON directly.',
    noEditablePluginParams: 'This plugin has no editable parameters.',
  ...
  llmSecurity: {
    ...
    configure: {
      ...
      customHeadersPlaceholder: 'Custom request headers in JSON',
      messageTemplate: 'Request Body Template',
      messageTemplateHint: 'Request',
      messageTemplatePlaceholder: 'Request body JSON template',
