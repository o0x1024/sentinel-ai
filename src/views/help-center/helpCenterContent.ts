    ...
    },
    {
      ...
      entries: [
        ...
        zhSecurityFindingsEntry,
        {
          ...
          capabilities: [
            '以 Traffic Workbench 作为统一主入口。',
            '包含代理、拦截、草稿实验、攻击工作区、比较器、历史记录、OAST 面板和辅助上下文能力。',
            '支持从历史或其他证据入口直接创建草稿、攻击工作区和对比任务；结果窗只作为可选辅助视图。',
          ...
          operations: [
            ...
            '选中请求后直接创建草稿、攻击工作区或对比任务，分别做修改复测、批量测试和差异比对。',
