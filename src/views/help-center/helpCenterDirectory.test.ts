...
describe('helpCenterDirectory', () => {
  it('builds a selectable document map for the help center tree', () => {
    ...
    expect(directory.documents['feature-bug-bounty-findings'].detailSections?.length).toBe(3)
  ...
  it('tracks each child document under its parent directory', () => {
    ...
    expect(directory.parentById['feature-bug-bounty-knowledge']).toBe('core-features')
