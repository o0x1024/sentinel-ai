...
const BURP_HTTP_TOKEN_TABLE = {
  ...
  'http-method': httpEditorMethodTag,
  'http-protocol': httpEditorProtocolTag,
  'http-path': t.url,
  ...
  'http-header-name': httpEditorHeaderNameTag,
  'http-header-name-important': httpEditorHeaderNameTag,
  'http-header-name-meta': httpEditorHeaderNameTag,
  'http-header-name-sensitive': httpEditorHeaderNameTag,
  'http-header-value': httpEditorHeaderValueTag,
  'http-header-value-important': httpEditorHeaderValueTag,
  'http-header-value-meta': httpEditorHeaderValueTag,
  'http-header-value-sensitive': httpEditorHeaderValueTag,
  'http-cookie-name': httpEditorCookieNameTag,
  'http-cookie-attribute': httpEditorCookieNameTag,
  'http-cookie-attribute-value': httpEditorCookieValueTag,
  'http-cookie-value-sensitive': httpEditorCookieValueTag,
  'http-cookie-flag': httpEditorCookieNameTag,
