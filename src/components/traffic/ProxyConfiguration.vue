<template>
  <div class="proxy-configuration-layout flex h-full min-h-0 gap-3">
    <aside
      class="proxy-configuration-sidebar flex min-h-0 w-[13rem] shrink-0 flex-col rounded-[24px] border border-base-300/80 bg-base-100/95 p-2.5 shadow-sm"
    >
      <div class="px-2 pb-3">
        <h2 class="mt-1 text-lg font-semibold text-base-content">代理配置</h2>
    ...
    >
      <div class="proxy-settings-grid" :class="activeSettingsGridClass">
        ...
        <div
          v-if="activeSettingsTab === 'listeners'"
          class="proxy-settings-card proxy-settings-card-wide card bg-base-100 shadow-xl"
        >
          <div class="card-body">
              ...
              <label class="label cursor-pointer justify-start gap-3 py-2">
                ...
                <div>
                  <span class="label-text font-medium">{{
                    $t('trafficAnalysis.proxyConfiguration.autoStartProxy')
                  }}</span>
                  <p class="text-xs text-base-content/60 mt-1">
                    {{ $t('trafficAnalysis.proxyConfiguration.autoStartProxyDesc') }}
                  </p>
                </div>
              </label>
            </div>
            ...
            <div class="mt-4 space-y-2">
              <div class="flex gap-2">
                <button class="btn btn-sm btn-outline" @click="openCertDialog">
          ...
          <div class="modal-box">
            ...
            <div class="space-y-4">
              <div class="form-control">
                <label class="label">
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.bindAddress')
                  }}</span>
                </label>
                <input
                  type="text"
              ...
              <div class="form-control">
                <label class="label">
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.certMode')
                  }}</span>
                </label>
                <select v-model="editingListener.certificate" class="select select-bordered">
                  <option value="Per-host">
                    {{ $t('trafficAnalysis.proxyConfiguration.perHostCert') }}
                  </option>
                  <option value="Wildcard">
                    {{ $t('trafficAnalysis.proxyConfiguration.wildcardCert') }}
                  </option>
                  <option value="Custom">
                    {{ $t('trafficAnalysis.proxyConfiguration.customCert') }}
                  </option>
                </select>
              </div>
              ...
              <div class="form-control">
                <label class="label">
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.tlsProtocols')
                  }}</span>
                </label>
                <select v-model="editingListener.tlsProtocols" class="select select-bordered">
                  <option value="Default">
                    {{ $t('trafficAnalysis.proxyConfiguration.defaultTLS') }}
                  </option>
                  <option value="TLS 1.2">
                    {{ $t('trafficAnalysis.proxyConfiguration.tls12') }}
                  </option>
                  <option value="TLS 1.3">
                    {{ $t('trafficAnalysis.proxyConfiguration.tls13') }}
                  </option>
                  <option value="TLS 1.2+1.3">
                    {{ $t('trafficAnalysis.proxyConfiguration.tls12Plus13') }}
                  </option>
                </select>
              </div>
              ...
              <div class="form-control">
                <label class="label cursor-pointer">
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.supportHTTP2')
                  }}</span>
                  <input type="checkbox" v-model="editingListener.supportHTTP2" class="checkbox" />
                </label>
              </div>
              ...
              <div class="form-control">
                <label class="label cursor-pointer">
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.invisibleMode')
                  }}</span>
                  <input type="checkbox" v-model="editingListener.invisible" class="checkbox" />
                </label>
              </div>
              ...
              <div class="form-control">
                <label class="label cursor-pointer">
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.enableRedirect')
                  }}</span>
                  <input type="checkbox" v-model="editingListener.redirect" class="checkbox" />
                </label>
              </div>
            </div>
            ...
            <div class="modal-action">
              ...
              <button class="btn btn-primary" @click="saveEdit">
                {{ $t('trafficAnalysis.proxyConfiguration.save') }}
              </button>
            </div>
          </div>
        ...
        <div
          v-if="activeSettingsTab === 'listeners'"
          class="proxy-settings-card card bg-base-100 shadow-xl"
        >
          <div class="card-body">
            <h2 class="card-title text-base mb-3">
            ...
            <div class="form-control">
              <label class="label cursor-pointer justify-start gap-2">
                <input type="checkbox" class="checkbox checkbox-sm" v-model="interceptRequests" />
                <span class="label-text">{{
                  $t('trafficAnalysis.proxyConfiguration.interceptRequests')
                }}</span>
                <span v-if="!masterInterceptionEnabled" class="text-warning text-sm italic">
            ...
            <div class="proxy-settings-table-editor flex gap-4 mt-2">
              ...
              <div class="flex flex-col gap-2 shrink-0">
                ...
                <button
                  ...
                  :disabled="
                    selectedRequestRuleIndex === -1 ||
                    selectedRequestRuleIndex >= requestRules.length - 1
                  "
                >
                ...
                <table class="table table-sm w-full">
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td class="font-mono text-xs max-w-xs truncate" :title="rule.condition">
                        {{ rule.condition || '-' }}
                      </td>
                    </tr>
                  </tbody>
            ...
            <div class="form-control mt-4">
              <label class="label cursor-pointer justify-start gap-2">
                ...
                <span class="label-text">{{
                  $t('trafficAnalysis.proxyConfiguration.autoFixNewlines')
                }}</span>
              </label>
            </div>
            ...
            <div class="form-control">
              <label class="label cursor-pointer justify-start gap-2">
                <input
                  type="checkbox"
                  class="checkbox checkbox-sm"
                  v-model="autoUpdateContentLength"
                />
                <span class="label-text">{{
                  $t('trafficAnalysis.proxyConfiguration.autoUpdateContentLength')
                }}</span>
              </label>
            </div>
          </div>
        ...
        <div
          v-if="activeSettingsTab === 'listeners'"
          ref="responseInterceptionRulesRef"
          class="proxy-settings-card card bg-base-100 shadow-xl"
        >
          <div class="card-body">
            <h2 class="card-title text-base mb-3">
            ...
            <div class="form-control">
              <label class="label cursor-pointer justify-start gap-2">
                <input type="checkbox" class="checkbox checkbox-sm" v-model="interceptResponses" />
                <span class="label-text">{{
                  $t('trafficAnalysis.proxyConfiguration.interceptResponses')
                }}</span>
                <span v-if="!masterInterceptionEnabled" class="text-warning text-sm italic">
                  {{
                    $t('trafficAnalysis.proxyConfiguration.masterInterceptionManagedInInterceptTab')
            ...
            <div class="proxy-settings-table-editor flex gap-4 mt-2">
              ...
              <div class="flex flex-col gap-2 shrink-0">
                ...
                <button
                  ...
                  :disabled="
                    selectedResponseRuleIndex === -1 ||
                    selectedResponseRuleIndex >= responseRules.length - 1
                  "
                >
                  {{ $t('trafficAnalysis.proxyConfiguration.moveDown') }}
                </button>
            ...
            <div class="form-control mt-4">
              <label class="label cursor-pointer justify-start gap-2">
                <input
                  type="checkbox"
                  class="checkbox checkbox-sm"
                  v-model="autoUpdateResponseContentLength"
                />
                <span class="label-text">{{
                  $t('trafficAnalysis.proxyConfiguration.autoUpdateResponseContentLength')
                }}</span>
              </label>
            </div>
          </div>
        ...
        <AppDialog ref="ruleDialogRef" class="modal">
          <div class="modal-box">
            <h3 class="font-bold text-lg mb-4">
              {{
                editingRuleIsNew
                  ? $t('trafficAnalysis.proxyConfiguration.addInterceptionRule')
                  : $t('trafficAnalysis.proxyConfiguration.editInterceptionRule')
              }}
            </h3>
            <p class="text-sm text-base-content/70 mb-4">
            ...
            <div class="space-y-4">
              <div class="form-control">
                <label class="label">
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.booleanOperator')
                  }}</span>
                </label>
              ...
              <div class="form-control">
                <label class="label">
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.matchType')
                  }}</span>
                </label>
              ...
              <div class="form-control">
                <label class="label">
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.matchRelationship')
                  }}</span>
                </label>
              ...
              <div class="form-control">
                <label class="label">
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.matchCondition')
                  }}</span>
                </label>
                <input
                  type="text"
            ...
            <div class="modal-action">
              <button class="btn btn-ghost" @click="cancelRuleEdit">
                {{ $t('trafficAnalysis.proxyConfiguration.cancel') }}
              </button>
              <button class="btn btn-primary" @click="saveRuleEdit">
          ...
          <div class="card-body">
            ...
            <div class="form-control mb-3">
              <label class="label cursor-pointer justify-start gap-2">
                ...
                <span class="label-text">{{
                  $t('trafficAnalysis.proxyConfiguration.onlyApplyToInScope')
                }}</span>
              </label>
            </div>
            ...
            <div class="proxy-settings-rule-editor flex gap-4">
              <div class="flex flex-col gap-2 shrink-0">
                ...
                <button
                  class="btn btn-sm btn-outline w-24"
                  :disabled="
                    selectedMatchReplaceIndex === -1 ||
                    selectedMatchReplaceIndex >= matchReplaceRules.length - 1
                  "
                ...
                <table class="table table-sm w-full">
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td class="font-mono text-xs max-w-xs truncate" :title="rule.match">
                        {{ rule.match }}
                      </td>
                      <td class="text-xs max-w-xs truncate" :title="rule.replace">
                        {{ rule.replace }}
                      </td>
        ...
        <div
          v-if="activeSettingsTab === 'listeners'"
          class="proxy-settings-card proxy-settings-card-compact card bg-base-100 shadow-xl"
        >
          <div class="card-body">
            <h2 class="card-title text-base mb-3">
              ...
              <div class="form-control">
                <label class="label cursor-pointer justify-start gap-2">
                  <input
                    type="checkbox"
                    class="checkbox checkbox-sm"
                    v-model="interceptClientToServer"
                  />
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.interceptClientToServer')
                  }}</span>
                </label>
              </div>
              ...
              <div class="form-control">
                <label class="label cursor-pointer justify-start gap-2">
                  <input
                    type="checkbox"
                    class="checkbox checkbox-sm"
                    v-model="interceptServerToClient"
                  />
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.interceptServerToClient')
                  }}</span>
                </label>
              </div>
              ...
              <div class="form-control">
                <label class="label cursor-pointer justify-start gap-2">
                  <input
                    type="checkbox"
                    class="checkbox checkbox-sm"
                    v-model="onlyInterceptInScope"
                  />
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.onlyInterceptInScope')
                  }}</span>
                </label>
              </div>
            </div>
          ...
          <div class="modal-box">
            <h3 class="font-bold text-lg mb-4">
              {{
                editingUpstreamIsNew
                  ? $t('trafficAnalysis.proxyConfiguration.addUpstreamProxy')
                  : $t('trafficAnalysis.proxyConfiguration.editUpstreamProxy')
              }}
            </h3>
            ...
            <div class="space-y-4">
              <div class="form-control">
                <label class="label">
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.destinationHost')
                  }}</span>
                </label>
                <input
                  type="text"
                ...
                <label class="label">
                  <span class="label-text-alt text-base-content/60">{{
                    $t('trafficAnalysis.proxyConfiguration.destinationHostHelp')
                  }}</span>
                </label>
              </div>
              ...
              <div class="form-control">
                <label class="label">
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.proxyHost')
                  }}</span>
                </label>
                <input
                  type="text"
              ...
              <div class="form-control">
                <label class="label">
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.proxyPort')
                  }}</span>
                </label>
                <input
                  type="number"
              ...
              <div class="form-control">
                <label class="label">
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.authType')
                  }}</span>
                </label>
                <select v-model="editingUpstream.auth_type" class="select select-bordered">
                  ...
                  <option value="Basic">
                    {{ $t('trafficAnalysis.proxyConfiguration.authBasic') }}
                  </option>
                </select>
              </div>
              ...
              <div v-if="editingUpstream.auth_type === 'Basic'" class="space-y-4">
                <div class="form-control">
                  <label class="label">
                    <span class="label-text">{{
                      $t('trafficAnalysis.proxyConfiguration.username')
                    }}</span>
                  </label>
                  <input
                    type="text"
                ...
                <div class="form-control">
                  <label class="label">
                    <span class="label-text">{{
                      $t('trafficAnalysis.proxyConfiguration.password')
                    }}</span>
                  </label>
                  <input
                    type="password"
            ...
            <div class="modal-action">
              <button class="btn btn-ghost" @click="cancelUpstreamEdit">
                {{ $t('trafficAnalysis.proxyConfiguration.cancel') }}
              </button>
              <button class="btn btn-primary" @click="saveUpstreamEdit">
                {{ $t('trafficAnalysis.proxyConfiguration.ok') }}
              </button>
            </div>
          </div>
          ...
          <div class="modal-box">
            <h3 class="font-bold text-lg mb-4">
              {{
                editingMatchReplaceIsNew
                  ? $t('trafficAnalysis.proxyConfiguration.addMatchReplaceRule')
                  : $t('trafficAnalysis.proxyConfiguration.editMatchReplaceRule')
              }}
            </h3>
            ...
            <div class="space-y-4">
              <div class="form-control">
                <label class="label">
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.type')
                  }}</span>
                </label>
                <select v-model="editingMatchReplace.type" class="select select-bordered w-full">
                  <option value="Request header">
                    {{ $t('trafficAnalysis.proxyConfiguration.matchReplaceTypes.requestHeader') }}
                  </option>
                  <option value="Request body">
                    {{ $t('trafficAnalysis.proxyConfiguration.matchReplaceTypes.requestBody') }}
                  </option>
                  <option value="Request param name">
                    {{
                      $t('trafficAnalysis.proxyConfiguration.matchReplaceTypes.requestParamName')
                    }}
                  </option>
                  <option value="Request param value">
                    {{
                      $t('trafficAnalysis.proxyConfiguration.matchReplaceTypes.requestParamValue')
                    }}
                  </option>
                  <option value="Request first line">
                    {{
                      $t('trafficAnalysis.proxyConfiguration.matchReplaceTypes.requestFirstLine')
                    }}
                  </option>
                  <option value="Response header">
                    {{ $t('trafficAnalysis.proxyConfiguration.matchReplaceTypes.responseHeader') }}
                  </option>
                  <option value="Response body">
                    {{ $t('trafficAnalysis.proxyConfiguration.matchReplaceTypes.responseBody') }}
                  </option>
                </select>
              </div>
              ...
              <div class="form-control">
                <label class="label">
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.match')
                  }}</span>
                </label>
                <input
                  type="text"
              ...
              <div class="form-control">
                <label class="label">
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.replace')
                  }}</span>
                </label>
                <input
                  type="text"
              ...
              <div class="form-control">
                <label class="label">
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.comment')
                  }}</span>
                </label>
                <input
                  type="text"
            ...
            <div class="modal-action">
              <button class="btn btn-ghost" @click="cancelMatchReplaceEdit">
                {{ $t('trafficAnalysis.proxyConfiguration.cancel') }}
              </button>
              <button class="btn btn-primary" @click="saveMatchReplaceEdit">
                {{ $t('trafficAnalysis.proxyConfiguration.ok') }}
              </button>
            </div>
          </div>
        ...
        <AppDialog ref="tlsPassThroughDialogRef" class="modal">
          <div class="modal-box">
            <h3 class="font-bold text-lg mb-4">
              {{
                editingTlsIsNew
                  ? $t('trafficAnalysis.proxyConfiguration.addTlsPassThrough')
                  : $t('trafficAnalysis.proxyConfiguration.editTlsPassThrough')
              }}
            </h3>
            ...
            <div class="space-y-4">
              <div class="form-control">
                <label class="label">
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.hostIPRange')
                  }}</span>
                </label>
                <input
                  type="text"
            ...
            <div class="modal-action">
              <button class="btn btn-ghost" @click="cancelTlsPassThroughEdit">
                {{ $t('trafficAnalysis.proxyConfiguration.cancel') }}
              </button>
              <button class="btn btn-primary" @click="saveTlsPassThroughEdit">
                {{ $t('trafficAnalysis.proxyConfiguration.ok') }}
              </button>
            </div>
          </div>
        ...
        <AppDialog ref="certDialogRef" class="modal">
          <div class="modal-box max-w-lg">
            ...
            <div class="space-y-4">
              ...
              <div>
                <h4 class="font-semibold mb-2">
                  {{ $t('trafficAnalysis.proxyConfiguration.exportSection') }}
                </h4>
                <div class="space-y-2">
                  <label
                    class="flex items-center gap-3 cursor-pointer p-2 rounded hover:bg-base-200"
                  >
                    <input
                      type="radio"
                      name="certOperation"
                    ...
                    />
                    <span class="text-sm">{{
                      $t('trafficAnalysis.proxyConfiguration.certInDerFormat')
                    }}</span>
                  </label>
                  <label
                    class="flex items-center gap-3 cursor-pointer p-2 rounded hover:bg-base-200"
                  >
                    ...
                    />
                    <span class="text-sm">{{
                      $t('trafficAnalysis.proxyConfiguration.privateKeyInDerFormat')
                    }}</span>
                  </label>
                  <label
                    class="flex items-center gap-3 cursor-pointer p-2 rounded hover:bg-base-200"
                  >
                    ...
                    />
                    <span class="text-sm">{{
                      $t('trafficAnalysis.proxyConfiguration.certAndKeyInPkcs12')
                    }}</span>
                  </label>
                </div>
              </div>
              ...
              <div>
                <h4 class="font-semibold mb-2">
                  {{ $t('trafficAnalysis.proxyConfiguration.importSection') }}
                </h4>
                <div class="space-y-2">
                  <label
                    class="flex items-center gap-3 cursor-pointer p-2 rounded hover:bg-base-200"
                  >
                    ...
                    />
                    <span class="text-sm">{{
                      $t('trafficAnalysis.proxyConfiguration.certAndKeyInDerFormat')
                    }}</span>
                  </label>
                  <label
                    class="flex items-center gap-3 cursor-pointer p-2 rounded hover:bg-base-200"
                  >
                    ...
                    />
                    <span class="text-sm">{{
                      $t('trafficAnalysis.proxyConfiguration.certAndKeyFromPkcs12')
                    }}</span>
                  </label>
                </div>
              </div>
            ...
            <div class="modal-action">
              <button class="btn btn-ghost" @click="closeCertDialog">
                {{ $t('trafficAnalysis.proxyConfiguration.cancel') }}
              </button>
              <button
            ...
            <div class="space-y-2">
              <div class="form-control">
                <label class="label cursor-pointer justify-start gap-2">
                  ...
                  />
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.enableInterception')
                  }}</span>
                </label>
              </div>
              ...
              <div class="form-control">
                <label class="label cursor-pointer justify-start gap-2">
                  ...
                  />
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.disableInterception')
                  }}</span>
                </label>
              </div>
              ...
              <div class="form-control">
                <label class="label cursor-pointer justify-start gap-2">
                  ...
                  />
                  <span class="label-text">{{
                    $t('trafficAnalysis.proxyConfiguration.restoreInterceptionState')
                  }}</span>
                </label>
              </div>
            </div>
...
const normalizeSettingsPanelState = (
  state?: {
    activeTab?: unknown
...
const persistSettingsPanelState = () => {
  ...
  setLocalStorageItem(settingsStateStorageKey, JSON.stringify(snapshot))
...
.proxy-settings-tab-active {
  ...
  background: linear-gradient(135deg, hsl(var(--p) / 0.12), transparent 62%), hsl(var(--b1));
